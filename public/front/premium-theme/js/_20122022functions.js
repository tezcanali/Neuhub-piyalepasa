...
$(document).ready(function () {
    ...
    owl6.owlCarousel({ smartSpeed: 700, loop: true, margin: 0, autoplay:false,responsiveClass: true, nav:true, dots:false, thumbs: false, thumbImage: false, items: 1, lazyLoad:true, responsive: { 0: {}, 780:{} }});
...
$(function(){
    ...
    $('.intltelinput').not('.rendered').addClass('rendered').each(function () {
        ...
        $this.intlTelInput({
            ...
            numberType: "MOBILE",
            formatOnInit: true,
            utilsScript: "assets/js/form/intl-tel-input/js/utils.js",
            initialCountry: 'tr',
            nationalMode: true,
